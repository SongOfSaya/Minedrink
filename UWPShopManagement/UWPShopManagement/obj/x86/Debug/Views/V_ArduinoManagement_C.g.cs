#pragma checksum "C:\Users\liute\Source\Repos\Minedrink\UWPShopManagement\UWPShopManagement\Views\V_ArduinoManagement_C.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "7539B53D3617322AF9CACD235B8B7C4F"
//------------------------------------------------------------------------------
// <auto-generated>
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IV_ArduinoManagement_C_Bindings
        {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 3: // Views\V_ArduinoManagement_C.xaml line 21
                        this.obj3 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 4: // Views\V_ArduinoManagement_C.xaml line 24
            ...
            private void Update_PIN_DT(global::System.Int32 obj, int phase)
            {
                ...
                {
                    // Views\V_ArduinoManagement_C.xaml line 21
            ...
            private void Update_PIN_SCK(global::System.Int32 obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Views\V_ArduinoManagement_C.xaml line 24
            ...
            IV_ArduinoManagement_C_Bindings
        {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 5: // Views\V_ArduinoManagement_C.xaml line 44
                        this.obj5 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 6: // Views\V_ArduinoManagement_C.xaml line 95
                        this.obj6 = (global::Windows.UI.Xaml.Controls.ListView)target;
                        break;
                    case 7: // Views\V_ArduinoManagement_C.xaml line 79
                        this.obj7 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 8: // Views\V_ArduinoManagement_C.xaml line 71
                        this.obj8 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 9: // Views\V_ArduinoManagement_C.xaml line 62
                        this.obj9 = (global::Windows.UI.Xaml.Controls.TextBlock)target;
                        break;
                    case 10: // Views\V_ArduinoManagement_C.xaml line 53
            ...
            private void Update_MasterMenuItem_Name(global::System.String obj, int phase)
            {
                ...
                {
                    // Views\V_ArduinoManagement_C.xaml line 44
            ...
            private void Update_MasterMenuItem_Arduino(global::UWPShopManagement.Models.M_ArduinoMarkA obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_MasterMenuItem_Arduino_SensorCollection(obj.SensorCollection, phase);
                    }
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
            ...
            private void Update_MasterMenuItem_Arduino_SensorCollection(global::System.Collections.ObjectModel.ObservableCollection<global::UWPShopManagement.Models.M_WeightSensor> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Views\V_ArduinoManagement_C.xaml line 95
            ...
            private void Update_MasterMenuItem_Arduino_IsConnect(global::System.Boolean obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\V_ArduinoManagement_C.xaml line 79
                    XamlBindingSetters.Set_Windows_UI_Xaml_Controls_TextBlock_Text(this.obj7, obj.ToString(), null);
                }
            }
            private void Update_MasterMenuItem_Arduino_Mills(global::System.Int64 obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\V_ArduinoManagement_C.xaml line 71
            ...
            private void Update_MasterMenuItem_Arduino_Mode(global::System.Int32 obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\V_ArduinoManagement_C.xaml line 62
            ...
            private void Update_MasterMenuItem_Arduino_ID(global::System.Int32 obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\V_ArduinoManagement_C.xaml line 53
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 6: // Views\V_ArduinoManagement_C.xaml line 95
                ...
                break;
            case 11: // Views\V_ArduinoManagement_C.xaml line 104
                {
                    this.WindowStates = (global::Windows.UI.Xaml.VisualStateGroup)(target);
                }
                break;
            case 12: // Views\V_ArduinoManagement_C.xaml line 105
                {
                    this.WideState = (global::Windows.UI.Xaml.VisualState)(target);
                }
                break;
            case 13: // Views\V_ArduinoManagement_C.xaml line 110
                {
        ...
        public global::Windows.UI.Xaml.Markup.IComponentConnector GetBindingConnector(int connectionId, object target)
        {
            ...
            case 1: // Views\V_ArduinoManagement_C.xaml line 1
                ...
                break;
            case 2: // Views\V_ArduinoManagement_C.xaml line 13
                {                    
