...
{
    public class VM_Shell : Observable
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<V_Main>("Shell_Main".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<V_ArduinoManagement>("Shell_MasterDetail".GetLocalized(), Symbol.Document));
            _secondaryItems.Add(ShellNavigationItem.FromType<V_Setting>("Shell_Settings".GetLocalized(), Symbol.Setting));
        }
