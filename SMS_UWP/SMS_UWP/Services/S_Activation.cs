...
namespace SMS_UWP.Services
{
    ...
    internal class S_Activation
    {
        ...
        public S_Activation(App app, Type defaultNavItem, UIElement shell = null)
        {
            _app = app;
        ...
        {
            await S_ThemeSelector.InitializeAsync();
            await Task.CompletedTask;
        }

        private async Task StartupAsync()
        {
            S_ThemeSelector.SetRequestedTheme();
            await Task.CompletedTask;
        }
