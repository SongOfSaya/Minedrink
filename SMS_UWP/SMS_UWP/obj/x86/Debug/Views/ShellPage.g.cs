...
namespace SMS_UWP.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class ShellPage_obj1_Bindings :
            ...
            IShellPage_Bindings
        {
            private global::SMS_UWP.Views.ShellPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::SMS_UWP.Views.ShellPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
            ...
            private void Update_ViewModel(global::SMS_UWP.ViewModels.ShellViewModel obj, int phase)
            {
            ...
            private class ShellPage_obj1_BindingsTracking
            {
                ...
                private global::SMS_UWP.ViewModels.ShellViewModel cache_ViewModel = null;
                public void UpdateChildListeners_ViewModel(global::SMS_UWP.ViewModels.ShellViewModel obj)
                {
