...
namespace SMS_UWP.Views
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class V_Shell_obj2_Bindings :
            ...
            IV_Shell_Bindings
        {
            private global::SMS_UWP.ViewModels.ShellNavigationItem dataRoot;
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                this.Update_((global::SMS_UWP.ViewModels.ShellNavigationItem) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            private void Update_(global::SMS_UWP.ViewModels.ShellNavigationItem obj, int phase)
            {
        ...
        private class V_Shell_obj1_Bindings :
            ...
            IV_Shell_Bindings
        {
            private global::SMS_UWP.Views.V_Shell dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::SMS_UWP.Views.V_Shell)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::SMS_UWP.Views.V_Shell obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
            ...
            private void Update_ViewModel(global::SMS_UWP.ViewModels.VM_Shell obj, int phase)
            {
            ...
            private class V_Shell_obj1_BindingsTracking
            {
                ...
                private global::SMS_UWP.ViewModels.VM_Shell cache_ViewModel = null;
                public void UpdateChildListeners_ViewModel(global::SMS_UWP.ViewModels.VM_Shell obj)
                {
